...
const deleteWorkout = document.querySelector('.delete_icon--container');
...
class App {
  ...
  _newWorkout(e) {
    ...
    // if ruunning , create running object
    if (type === 'running') {
  ...
  _renderWorkout(workout) {
    let html = `
      ...
      <ion-icon class="workout__delete--icon" name="close-outline"></ion-icon>
      </div>
